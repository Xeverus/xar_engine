...
{
    gpu_asset::GpuMaterialReference GpuMaterialModuleImpl::make_gpu_material(const MakeGpuMaterialParameters& parameters)
    {
    ...
    graphics::api::ImageReference GpuMaterialModuleImpl::init_texture(const asset::Image& image)
    {

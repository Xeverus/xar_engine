...
namespace xar_engine::graphics::backend::component
{
    ...
    struct IImageComponent::MakeImageParameters
    {
    ...
    struct IImageComponent::MakeImageViewParameters
    {
    ...
    struct IImageComponent::MakeSamplerParameters
    {
        float mip_levels;
    };

    struct IImageComponent::GenerateImageMipMapsParameters
    {
        api::CommandBufferReference command_buffer;
        api::ImageReference image;
    };

    struct IImageComponent::TransitImageLayoutParameters
    {
        api::CommandBufferReference& command_buffer;
        api::ImageReference& image;

...
{
    api::SwapChainReference IVulkanSwapChainComponent::make_swap_chain(const MakeSwapChainParameters& parameters)
    {
    ...
    std::tuple<api::ESwapChainResult, std::uint32_t, std::uint32_t> IVulkanSwapChainComponent::begin_frame(const BeginFrameParameters& parameters)
    {
    ...
    void IVulkanSwapChainComponent::begin_rendering(const BeginRenderingParameters& parameters)
    {
    ...
    void IVulkanSwapChainComponent::end_rendering(const EndRenderingParameters& parameters)
    {
    ...
    api::ESwapChainResult IVulkanSwapChainComponent::end_frame(const EndFrameParameters& parameters)
    {

...
#include "vulkan_descriptor_unit.hpp"
...
namespace xar_engine::graphics::backend::unit::vulkan
{
    ...
    api::DescriptorPoolReference IVulkanDescriptorUnit::make_descriptor_pool(const MakeDescriptorPoolParameters& parameters)
    {
    ...
    api::DescriptorSetLayoutReference IVulkanDescriptorUnit::make_descriptor_set_layout(const MakeDescriptorSetLayoutParameters& parameters)
    {
    ...
    std::vector<api::DescriptorSetReference> IVulkanDescriptorUnit::make_descriptor_set_list(const MakeDescriptorSetParameters& parameters)
    {
    ...
    void IVulkanDescriptorUnit::write_descriptor_set(const WriteDescriptorSetParameters& parameters)
    {

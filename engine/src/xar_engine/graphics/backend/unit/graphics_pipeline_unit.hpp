...
namespace xar_engine::graphics::backend::unit
{
    ...
    struct IGraphicsPipelineUnit::MakeGraphicsPipelineParameters
    {
    ...
    struct IGraphicsPipelineUnit::SetPipelineStateParameters
    {
    ...
    struct IGraphicsPipelineUnit::SetVertexBufferListParameters
    {
        api::CommandBufferReference command_buffer;
    ...
    struct IGraphicsPipelineUnit::SetIndexBufferParameters
    {
        api::CommandBufferReference command_buffer;
    ...
    struct IGraphicsPipelineUnit::PushConstantsParameters
    {
    ...
    struct IGraphicsPipelineUnit::DrawIndexedParameters
    {
        api::CommandBufferReference command_buffer;

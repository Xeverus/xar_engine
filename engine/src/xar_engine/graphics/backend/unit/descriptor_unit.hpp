...
namespace xar_engine::graphics::backend::unit
{
    ...
    struct IDescriptorUnit::MakeDescriptorPoolParameters
    {
        std::set<api::EDescriptorType> descriptor_pool_type_list;
    };

    struct IDescriptorUnit::MakeDescriptorSetLayoutParameters
    {
        std::set<api::EDescriptorType> descriptor_pool_type_list;
    };

    struct IDescriptorUnit::MakeDescriptorSetParameters
    {
    ...
    struct IDescriptorUnit::WriteDescriptorSetParameters
    {

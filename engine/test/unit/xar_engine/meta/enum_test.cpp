...
namespace
{
    TEST(enum_in_namespace, enum_to_string)
    {
        ...
        EXPECT_STREQ(value_0, "enum_test::ns::EnumTestEnum::VALUE_0");
        EXPECT_STREQ(value_1, "enum_test::ns::EnumTestEnum::VALUE_1");
        EXPECT_STREQ(value_2, "enum_test::ns::EnumTestEnum::VALUE_2");
    }

    TEST(enum_in_namespace, enum_to_string_operator)
    {
        ...
        EXPECT_STREQ(str_value_0.str().c_str(), "enum_test::ns::EnumTestEnum::VALUE_0");
        EXPECT_STREQ(str_value_1.str().c_str(), "enum_test::ns::EnumTestEnum::VALUE_1");
        EXPECT_STREQ(str_value_2.str().c_str(), "enum_test::ns::EnumTestEnum::VALUE_2");
    }

    TEST(enum_in_namespace, enum_to_short_string)
    {
        ...
        EXPECT_STREQ(value_0, "VALUE_0");
        EXPECT_STREQ(value_1, "VALUE_1");
        EXPECT_STREQ(value_2, "VALUE_2");
    }

    TEST(enum_without_namespace, enum_to_string)
    {
        ...
        EXPECT_STREQ(value_0, "EnumTestEnum::VALUE_10");
        EXPECT_STREQ(value_1, "EnumTestEnum::VALUE_11");
        EXPECT_STREQ(value_2, "EnumTestEnum::VALUE_12");
    }

    TEST(enum_without_namespace, enum_to_string_operator)
    {
        std::stringstream str_value_0;
        std::stringstream str_value_1;
        std::stringstream str_value_2;
        ...
        EXPECT_STREQ(str_value_0.str().c_str(), "EnumTestEnum::VALUE_10");
        EXPECT_STREQ(str_value_1.str().c_str(), "EnumTestEnum::VALUE_11");
        EXPECT_STREQ(str_value_2.str().c_str(), "EnumTestEnum::VALUE_12");
    }

    TEST(enum_without_namespace, enum_to_short_string)
    {
        ...
        EXPECT_STREQ(value_0, "VALUE_10");
        EXPECT_STREQ(value_1, "VALUE_11");
        EXPECT_STREQ(value_2, "VALUE_12");
    }
}
...
namespace
{
    ...
    {
        auto instance = xar_engine::meta::RefCountedSingleton::get_instance<RefCountedTestClass>();
        ASSERT_NE(instance,
                  nullptr);
         ...
         update_value_and_get_instance_again__value_preserved)
    {
        ...
        instance = xar_engine::meta::RefCountedSingleton::get_instance<RefCountedTestClass>();
        EXPECT_EQ(instance->value, 100);
    }
